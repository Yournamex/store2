...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('<?php echo $config["bg"]; ?>');
...
<body style="background-color: #F4FEFF!important;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto  mb-2 mb-lg-0">
                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        <a class="nav-link underline-active align-self-center" aria-current="page" href="/?page=home"><i class="fa-regular fa-house"></i>&nbsp;หน้าหลัก</a>
                    </li>
                    <li class="nav-item align-self-center ms-lg-3">
                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        <a class="nav-link underline-active align-self-center" aria-current="page" href="/?page=topup"><i class="fa-regular fa-coins"></i>&nbsp;เติมเงิน</a>
                    </li>
                    <li class="nav-item align-self-center ms-lg-3">
                    ...
                    <ul class="navbar-nav ms-auto  mb-2 mb-lg-0 ">
                        ...
                        <li class="nav-item dropdown" style="list-style: none;">
                            ...
                            <ul class="dropdown-menu shadow-sm p-4 pt-2 pb-2" style="border-radius: 0px;" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item text-dark mb-2" href="?page=logout"><small><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;ออกจากระบบ</small></a></li>
                            </ul>
                        </li>
                    </ul>
                <?php
    ...
    <div class="container-fluid p-0">
        <div class="container-sm m-auto p-4 pb-0">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3">
                    <div class="container-fluid p-0 bg-white rounded shadow-sm border  mb-4">
                        <a href="?page=redeem" style="text-decoration: none;" data-aos="zoom-in" data-aos-duration="1000">
                            <div class="align-self-center pt-3 pb-1 ">
                                <center>
                                    <img src="assets/icon/box.png" style="height: 3rem;">
                ...
                <div class="col-lg-3">
                    <div class="container-fluid p-0 bg-white rounded shadow-sm border  mb-4">
                        <a href="<?php echo $config['contact']; ?>" style="text-decoration: none;" data-aos="zoom-in" data-aos-duration="1000">
                            <div class="align-self-center pt-3 pb-1 ">
                                <center>
                                    <img src="assets/icon/call-center.png" style="height: 3rem;">
                                    <h4 class="text-dark mt-2">&nbsp;ช่องทางการติดต่อ</h4>
                                </center>
                            </div>
                        </a>
                    </div>
    ...
    <div class="container-fluid bg-white shadow pt-5 pb-5 mt-3">
        <center>
            <p class="text-dark mb-1"><strong>Copyright <i class="fa-regular fa-copyright"></i>&nbsp; 2023 <a href="https://discord.gg/overdrive-c" class="text-dark"><?php echo $s_info['name']; ?></a> , All right reserved.</strong></p>
            <small class="text-dark "><i class="fa-solid fa-rabbit"></i>&nbsp; Overdrive | Cloud <a href="https://discord.gg/overdrive-c" class="text-dark"> ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
        </center>
    </div>
